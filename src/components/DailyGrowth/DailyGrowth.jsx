          ...
          : (
            <ResponsiveContainer height={180}>
              <LineChart data={groupedData}>
                ...
                />
                <Line name="Potw. przypadki" type="monotone" dataKey={CASES_KEY} strokeWidth={2} stroke={theme.colors.negative} dot={false} />
                <Line name="Zgony" type="monotone" dataKey={DEATHS_KEY} strokeWidth={2} stroke={theme.colors.primary} dot={false} />
                <Line name="Wyleczenia" type="monotone" dataKey={CURES_KEY} strokeWidth={2} stroke={theme.colors.positive} dot={false} />
              </LineChart>
            </ResponsiveContainer>
          )}
      </StyledBody>
